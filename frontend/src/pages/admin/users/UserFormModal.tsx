...
export function UserFormModal({
  ...
  useEffect(() => {
    operationsApi
      .departments()
      .then((r) => setDepartments(r.data.map((item) => item.name)));
  }, []);
  ...
  const valid =
    ...
    (librarian ||
      ...
      validClassName(form.class_name));
  return (
    <Modal title="Chỉnh sửa thành viên" onClose={onClose}>
      ...
      <div className="form-grid">
          ...
          <label>
            ...
            {initial.user_type === "student" ? (
              <input
                ...
                onChange={(e) =>
                  update("class_name", normalizeClassName(e.target.value))
                }
              />
            ) : (
              <Selector
        ...
        <label>
          ...
          />
          {form.phone && !validPhone(form.phone) && (
