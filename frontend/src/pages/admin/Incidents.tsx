  ...
  return (
    <>
      <Toolbar
        ...
        filters={
          <label>
            <FieldLabel>Trạng thái sự cố</FieldLabel>
            <Selector
              value={status}
        ...
        <section className="panel table-panel incidents-table">
          <div className="panel-heading">
            <div>
              ...
              <p className="muted">
                Xử lý từng sự cố theo hồ sơ; không làm thay đổi lịch sử lưu
                thông.
              </p>
            </div>
          </div>
                        ...
                        actions={[
                          {
                            ...
                            icon: Check,
                            onSelect: () =>
                              setPendingAction({ item, waive: false }),
                          },
                          {
                            label: "Miễn bồi hoàn",
                            icon: HandCoins,
                            tone: "danger",
                            onSelect: () =>
                              setPendingAction({ item, waive: true }),
                          },
                        ]}
                      />
                    )}
      ...
      {pendingAction && (
        <ConfirmDialog
          ...
          description={
            pendingAction.waive
              ? `Miễn bồi hoàn cho ${pendingAction.item.inventory_code}? Thao tác này sẽ được lưu vào hồ sơ sự cố.`
              : `Xác nhận đã giải quyết sự cố của ${pendingAction.item.inventory_code}.`
          }
          confirmLabel={
            pendingAction.waive ? "Xác nhận miễn" : "Xác nhận giải quyết"
          }
